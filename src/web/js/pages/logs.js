...
const SPEED_TIP='总 Token ÷ 耗时(t/s);无 Token 或耗时的请求显示 -';
...
export default {props:['token'],setup(p){
  ...
  function speed(x){const d=Number(x.duration_ms)||0;const t=Number(x.total_tokens)||0;return d>0&&t>0?fmtTps(t*1000/d):'-'}
